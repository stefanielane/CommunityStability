...
clock_bogbean <- join_40 %>% 
  ...
  filter(Species %in% c("METR3", "MYSC", "BICE", "LYSA2", "EQFL", "LYTH2", "MEAQ", "JUAR", "ELPA3", "EQVA", "DECE", "GATR3"))
...
clock_fescue <- join_40 %>% 
  ...
  filter(Species %in% c("FEAR", "SALUL", "EQPA", "LAPA4", "SIHE4", "DECE", "POPA2", "TRWO", "BICE", "PHAR3", "EQFL"))

...
sp_table <- join_40 %>%
  ...
  mutate(Status = ifelse(Species == c("AGST2", "CIAR4", "FEAR3", "IRPS", "LYEU", "LYSA2", "MEAQ", "MEAR", "MYSC", "PHAR3", "RUCO2"), "Non-native",
                ifelse(Species == c("Galium_sp", "Poaceae_misc", "Asteraceae_misc", "Carex_sp1", "Festuca_sp", "Salix_sp"), "Unknown", "Native"))) %>%
  mutate(Species = recode(Species, 
            ...
            "EQVA" = "Equisetum variegatum", "FEAR3" = "Festuca arundinacea", "Galium_sp" = "Galium sp.", "GATR3"  ="Galium trifidum",
